    ...
    <footer className="bg-gray-800 dark:bg-gray-900 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-white">SHMS</h3>
            <p className="mt-2 text-gray-400">Revolutionizing healthcare management for a better, more efficient future.</p>
          </div>
          <div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Smart Hospital Management System. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
